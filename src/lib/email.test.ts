...
const verifyOtp = verifyEmail({ otp: "123456", url: "https://getcitebrief.com/verify?email=a@b.com" });
assert.match(verifyOtp.subject, /verification code/);
assert.match(verifyOtp.html, /123456/);
assert.match(verifyOtp.text, /123456/);
